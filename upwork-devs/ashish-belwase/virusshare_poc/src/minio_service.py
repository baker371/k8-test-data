...
class Minio():
    ...
    def __init__(self, url, access_key, secret_key):
        self.url = url
        self.s3 = boto3.resource('s3', endpoint_url=url, aws_access_key_id=access_key,
    ...
    def download_files(self, bucket_name, num_files):
        ...
        try:
            ...
            logger.error(
                "Cannot Connect to the Minio {}. Please Verify your credentials.".format(self.url))
        except e:
            logger.error(e)
    ...
    def upload_to_minio(self, file_path, bucket_name, filename):
        ...
        try:
            ...
            self.s3.Bucket(bucket_name).upload_file(file_to_upload, filename)
            return bucket_name + "/" + filename
        except ClientError as e:
            logger.error(
                "Cannot connect to the minio {}. Please vefify the Credentials.".format(self.url))
        except e:
            logger.error(e)